...
::GenerateData()
{
  ...
  typedef itk::BinaryFunctorImageFilter< InternalImageType,
                InternalImageType,
                InternalImageType,
                typename Functor::MaximumEntropyRichardsonLucy< TInternalPrecision > >
                  MaximumEntropyRichardsonLucyType;
  typename MaximumEntropyRichardsonLucyType::Pointer ediv = MaximumEntropyRichardsonLucyType::New();
  ...
  typedef itk::BinaryFunctorImageFilter< InternalImageType,
                InternalImageType,
                InternalImageType,
                typename Functor::MultiplyByXMinusLambdaXLnX< TInternalPrecision > > RealMultType;
  typename RealMultType::Pointer rmult = RealMultType::New();
  rmult->SetInput( 0, ifft2->GetOutput() );
  rmult->SetInput( 1, input );
  rmult->GetFunctor().m_Lambda = m_Lambda;
